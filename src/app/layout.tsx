...
export default function RootLayout({children}: {
	...
	return (
		...
		<body>
		<div className={"flex flex-1 flex-col w-full h-fit items-center space-y-4"}>
			<div
				...
				<div className={"flex flex-col max-w-[800px] 2xl:max-w-[1800px] w-full p-2 pt-4"}>
					<Header/>
					<div className={"w-full max-w-[800px] 2xl:max-w-[1800px] h-0 border-b-2 mt-2 border-black dark:border-white"}/>
				</div>
			</div>
			<div className={"z-10 py-16 flex flex-col w-full h-fit items-center overflow-x-hidden"}>
				<div className={"flex flex-col w-full max-w-[800px] 2xl:max-w-[1800px] p-4"}>
					{children}
				</div>
			</div>
		</div>
