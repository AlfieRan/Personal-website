...
const Projects: {
...
}[] = [
	{
		name: "Elo.ai",
		description:
			"Saving enterprise clients thousands of hours by revolutionising the way they complete question answering tasks " +
	...
	},
	{
		...
		description: `Winner of Anthropic's 2023 London Hackathon and built in just 24 hours, Bulletpapers.ai is a platform that summarises academic papers into a variety of formats, allowing users to quickly understand the key points of a paper without having to read the entire thing.\nBuilt with Matt Falconer and Claudio Lemos.`,
					...
					>
						...
						<div className={"space-y-1"}>
							{project.description
								.split("\n")
								.map((line, index) => (
									<p key={project.name + "_line_" + index}>
										{line}
									</p>
								))}
						</div>
