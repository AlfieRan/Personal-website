...
const ALevel = ({subject, grade}: { subject: string; grade: string }) => (
	<motion.div
		className={"col-span-1 flex flex-col w-full h-full bg-white rounded-lg shadow-lg py-4 px-6 justify-between items-center space-y-3"}
		initial={{scale: 0.8}}
		whileInView={{scale: 1}}
	...
	>
		<div
			className={"flex flex-row items-center justify-center text-center text-sm px-4 py-1 mb-1 rounded-full bg-green-300 font-semibold"}>
			<p>A Level</p>
		</div>
