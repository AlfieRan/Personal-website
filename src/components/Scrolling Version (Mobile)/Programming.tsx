            ...
            <Center mt={"10vh"} flexWrap={"wrap"} px={"lg"} minH={"100vh"}>
                ...
                >
                    ...
                    >
                        ...
                        <Text mb={2}>
                            I started my programming journey with an arduino
                            nano, an old laptop and a lot of creativity.
                        </Text>
                        <Text mb={2}>
                            In the ~{calcDif(2014, 8, 0)} years that I&apos;ve
                            been programming a lot has changed, I&apos;ve
                            learned a lot and I&apos;ve moved from arduino and a
                            little bit of C to a myriad of technologies.
                        </Text>
                    </Flex>
