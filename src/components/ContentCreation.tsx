...
const ContentCreation = () => {
  ...
  // const [wrap, setWrap] = useState<"wrap" | "no-wrap">("no-wrap");
  //
  // useEffect(() => {
    ...
    <>
      <Center  minH={"100vh"} flexWrap={"wrap"} mt={"10vh"}>
        <Flex flexDir={"column"} p={10} w={"lg"} maxW={"90vw"} fontSize={"md"}>
          ...
          <Text>
            I&apos;m a very creative person. So creative in fact that I tend to
            be limited more by what I can do than what I can imagine.
          </Text>
          <Text mt={2}>
          ...
          <Text mt={2}>
            ...
            family during a trip to Spain and I&apos;ve been hooked ever since.
          </Text>
          <Text mt={2}>
            Since then I&apos;ve created approximately 100 videos across a
            handful of youtube channels and private family videos and my work
