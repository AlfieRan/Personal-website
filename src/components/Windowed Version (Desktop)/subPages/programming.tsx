    ...
    <Center px={"lg"} flexDir={"column"}>
      <Flex flexDir={"column"} textAlign={"left"} maxW={"85vw"} mx={"15px"}>
        <Flex mb={5} flexDir={"column"} w={"xl"} fontSize={"sm"} maxW={"85vw"}>
          ...
          <Text mb={2}>
            In the ~{calcDif(2014, 8, 0)} years that I&apos;ve been programming
            a lot has changed, I&apos;ve learned a lot and I&apos;ve moved from
            arduino and a little bit of C to a myriad of technologies.
          </Text>
        </Flex>
