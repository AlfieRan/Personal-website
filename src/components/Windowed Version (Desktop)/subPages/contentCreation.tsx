        ...
        <>
            <Center flexDir={"column"} w={"100%"}>
                ...
                >
                    ...
                    <Text mt={2}>
                        I&apos;ve been working on videos since the age of 10,
                        when I first edited together a series of mini clips I
                        took of myself and my family on holiday and I&apos;ve
                        been hooked ever since.
                    </Text>
                    <Text mt={2}>
                        Since then I&apos;ve created approximately 100 videos
                        across a handful of youtube channels and other places
                        and my work has been viewed over 1.5 million times.
                    </Text>
                    <Text mt={2}>
                        If you wish to sponsor a video or have any questions
